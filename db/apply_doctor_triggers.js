...
async function applyTriggers() {
  ...
  try {
    ...
    await connection.query('DROP TRIGGER IF EXISTS before_appointment_insert');
    await connection.query('DROP TRIGGER IF EXISTS before_appointment_update');
    console.log('Existing triggers dropped successfully');
