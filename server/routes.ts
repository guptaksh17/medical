...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.put(`${apiPrefix}/patients/:id`, async (req, res) => {
    try {
      const patientId = parseInt(req.params.id);
      if (isNaN(patientId)) {
        return res.status(400).json({ message: 'Invalid patient ID' });
  ...
  app.delete(`${apiPrefix}/patients/:id`, async (req, res) => {
    try {
      const patientId = parseInt(req.params.id);
      if (isNaN(patientId)) {
        return res.status(400).json({ message: 'Invalid patient ID' });
  ...
  app.get(`${apiPrefix}/doctors/:id`, async (req, res) => {
    try {
  ...
  app.delete(`${apiPrefix}/doctors/:id`, async (req, res) => {
    try {
      const doctorId = parseInt(req.params.id);
      if (isNaN(doctorId)) {
        return res.status(400).json({ message: 'Invalid doctor ID' });
  ...
  app.get(`${apiPrefix}/appointments/upcoming`, async (req, res) => {
    try {
  ...
  app.get(`${apiPrefix}/appointments/patient/:patientId`, async (req, res) => {
    try {
  ...
  app.get(`${apiPrefix}/appointments/doctor/:doctorId`, async (req, res) => {
    try {
  ...
  app.get(`${apiPrefix}/feedback`, async (req, res) => {
    try {
  ...
  app.get(`${apiPrefix}/feedback/recent`, async (req, res) => {
    try {
  ...
  app.get(`${apiPrefix}/feedback/:id`, async (req, res) => {
    try {
  ...
  app.get(`${apiPrefix}/feedback/appointment/:appointmentId`, async (req, res) => {
    try {
  ...
  app.get(`${apiPrefix}/doctors/top-rated`, async (req, res) => {
    try {
      const limit = req.query.limit ? parseInt(req.query.limit as string) : 5;
  ...
  app.put(`${apiPrefix}/feedback/:id`, async (req, res) => {
    try {
      const feedbackId = parseInt(req.params.id);
      if (isNaN(feedbackId)) {
        return res.status(400).json({ message: 'Invalid feedback ID' });
  ...
  app.delete(`${apiPrefix}/feedback/:id`, async (req, res) => {
    try {
      const feedbackId = parseInt(req.params.id);
      if (isNaN(feedbackId)) {
        return res.status(400).json({ message: 'Invalid feedback ID' });
